...
export default function ViewerPdf() {
  ...
  return (
    <section>
      ...
      {/*  }}*/}
      {/*/>*/}
      <PDFObject url='https://apros-qa.net.pe/armandoparedes/wp-content/uploads/2021/08/Pasaje-Laureles-Cuadernillo-de-planos.pdf' width="100%" height="100vh" forcePDFJS={true} PDFJS_URL={true}/>
      {/*<object*/}
